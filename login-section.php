<div class="w3_agilits_banner_bootm">
	<div class="w3_agilits_inner_bottom">
		<div class="col-md-12 wthree_agile_login">
			<ul>
				<li><i class="fa fa-phone" aria-hidden="true"></i> 7977862667</li>
				...
				<li style="margin-left: 2%;		float:right"><a class="login reg"  href="bill.php">Bill</a> </li>
				<li style="margin-left: 2%;		float:right"><a class="login reg"  href="booking_h.php">Schedule</a> </li>
