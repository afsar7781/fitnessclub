...
var workoutid = $(this).attr("data-workoutid");
...
method:'post',
data:{'no_of_seats':no_of_seats,'booking_for':booking_for,'package_id':package_id,'workoutid':workoutid,'book_ticket':1},
...
var date  = $(this).val();
var workoutid = $("#workoutid").attr("data-workoutid");
...
url : "movie_data.php",
method:"post",
data:{"new_date":date,"no_of_seats":no_of_seats,"workoutid":workoutid,"package_id":package_id},
success:function(data){
$("#show").html(data);
